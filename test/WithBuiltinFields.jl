...
@testset "Structs with builtin fields" begin
    @test begin
        ...
        pub struct WithArray<'frame, 'data> {
            pub a: ::std::option::Option<::jlrs::wrappers::ptr::array::ArrayRef<'frame, 'data>>,
        }"""
    end
    ...
    @test begin
        ...
        pub struct WithDataType<'frame> {
            pub a: ::std::option::Option<::jlrs::wrappers::ptr::datatype::DataTypeRef<'frame>>,
        }"""
    end
    ...
    @test begin
        ...
        pub struct WithString<'frame> {
            pub a: ::std::option::Option<::jlrs::wrappers::ptr::string::StringRef<'frame>>,
        }"""
    end
    ...
    @test begin
        ...
        pub struct WithModule<'frame> {
            pub a: ::std::option::Option<::jlrs::wrappers::ptr::module::ModuleRef<'frame>>,
        }"""
    end
    ...
    @test begin
        ...
        pub struct WithSimpleVector<'frame> {
            pub a: ::std::option::Option<::jlrs::wrappers::ptr::simple_vector::SimpleVectorRef<'frame>>,
        }"""
    end
    ...
    @test begin
        ...
        pub struct WithSymbol<'frame> {
            pub a: ::std::option::Option<::jlrs::wrappers::ptr::symbol::SymbolRef<'frame>>,
        }"""
    end
    ...
    @test begin
        ...
        pub struct WithTask<'frame> {
            pub a: ::std::option::Option<::jlrs::wrappers::ptr::task::TaskRef<'frame>>,
        }"""
    end
    ...
    @test begin
        ...
        pub struct WithTypeName<'frame> {
            pub a: ::std::option::Option<::jlrs::wrappers::ptr::type_name::TypeNameRef<'frame>>,
        }"""
    end
    ...
    @test begin
        ...
        pub struct WithTypeVar<'frame> {
            pub a: ::std::option::Option<::jlrs::wrappers::ptr::type_var::TypeVarRef<'frame>>,
        }"""
    end
    ...
    @test begin
        ...
        pub struct WithUnion<'frame> {
            pub a: ::std::option::Option<::jlrs::wrappers::ptr::union::UnionRef<'frame>>,
        }"""
    end
    ...
    @test begin
        ...
        pub struct WithUnionAll<'frame> {
            pub a: ::std::option::Option<::jlrs::wrappers::ptr::union_all::UnionAllRef<'frame>>,
        }"""
    end
    ...
    @test begin
        ...
        pub struct WithCodeInstance<'frame> {
            pub a: ::std::option::Option<::jlrs::wrappers::ptr::internal::code_instance::CodeInstanceRef<'frame>>,
        }"""
    end
    ...
    @test begin
        ...
        pub struct WithExpr<'frame> {
            pub a: ::std::option::Option<::jlrs::wrappers::ptr::internal::expr::ExprRef<'frame>>,
        }"""
    end
    ...
    @test begin
        ...
        pub struct WithMethod<'frame> {
            pub a: ::std::option::Option<::jlrs::wrappers::ptr::internal::method::MethodRef<'frame>>,
        }"""
    end
    ...
    @test begin
        ...
        pub struct WithMethodInstance<'frame> {
            pub a: ::std::option::Option<::jlrs::wrappers::ptr::internal::method_instance::MethodInstanceRef<'frame>>,
        }"""
    end
    ...
    @test begin
        ...
        pub struct WithMethodTable<'frame> {
            pub a: ::std::option::Option<::jlrs::wrappers::ptr::internal::method_table::MethodTableRef<'frame>>,
        }"""
    end
    ...
    @test begin
        ...
        pub struct WithTypeMapEntry<'frame> {
            pub a: ::std::option::Option<::jlrs::wrappers::ptr::internal::typemap_entry::TypeMapEntryRef<'frame>>,
        }"""
    end
    ...
    @test begin
        ...
        pub struct WithTypeMapLevel<'frame> {
            pub a: ::std::option::Option<::jlrs::wrappers::ptr::internal::typemap_level::TypeMapLevelRef<'frame>>,
        }"""
    end
end
